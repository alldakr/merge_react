                        ...
                        <Col lg='4'>
                            <Card
                                ...
                                style={{
                                    backgroundImage:
                                        'url(' +
                                        require('assets/argon-design/img/theme/masha-rostovskaya.jpg') +
                                        ')',
                                }}>
                                <CardBody className='text-left'>
                                    ...
                                    <h6 className='desc text-white opacity-8'>
                                        Java App
                                    </h6>
                                    <Button
                                        color='warning'
                        ...
                        <Col lg='4'>
                            <Card
                                ...
                                style={{
                                    backgroundImage:
                                        'url(' +
                                        require('assets/argon-design/img/theme/ali-pazani.jpg') +
                                        ')',
                                }}>
                        ...
                        <Col lg='4'>
                            <Card
                                ...
                                style={{
                                    backgroundImage:
                                        'url(' +
                                        require('assets/argon-design/img/theme/willy-dade.jpg') +
                                        ')',
                                }}>
