                            ...
                            <Col
                                ...
                                <div className='info info-horizontal ml-0'>
                                    ...
                                    <div className='description'>
                                        ...
                                        <p className='text-white opacity-8'>
                                            ...
                                            Cause pain is what we go through as
                                            we become older and we get insulted
                                        </p>
                                    </div>
                                </div>
                                <div className='info info-horizontal ml-0'>
                                    ...
                                    <div className='description'>
                                        ...
                                        <p className='text-white opacity-8'>
                                            We get back stabbed by friends. It
                                            becomes harder for us to give others
                                            a hand. We get our heart broken by
                                            people we love.
                                        </p>
                                    </div>
                                </div>
                                <div className='info info-horizontal ml-0'>
                                    ...
                                    <div className='description'>
                                        ...
                                        <p className='text-white opacity-8'>
                                            When we lose family over time. What
                                            else could rust the heart more over
                                            time? Blackgold. It becomes
                                            harder...
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <ul className='glide__slides'>
                                            <li className='glide__slide'>
                                                <img
                                                    alt='...'
                                                    height='500'
                                                    src={require('assets/argon-design/img/theme/victor-garcia.jpg')}
                                                    width='450'></img>
                                            </li>
                                            <li className='glide__slide'>
                                                <img
                                                    alt='...'
                                                    height='500'
                                                    src={require('assets/argon-design/img/theme/sacha-styles.jpg')}
                                                    width='450'></img>
                                            </li>
                                            <li className='glide__slide'>
                                                <img
                                                    alt='...'
                                                    height='500'
                                                    src={require('assets/argon-design/img/theme/doyoun-seo.jpg')}
                                                    width='450'></img>
                                            </li>
                                            <li className='glide__slide'>
                                                <img
                                                    alt='...'
                                                    height='500'
                                                    src={require('assets/argon-design/img/theme/sofia-kuniakina.jpg')}
                                                    width='450'></img>
                                            </li>
                                            <li className='glide__slide'>
                                                <img
                                                    alt='...'
                                                    height='500'
                                                    src={require('assets/argon-design/img/theme/ayo-ogunseinde.jpg')}
                                                    width='450'></img>
                                            </li>
                                        </ul>
                                    </div>
