                            ...
                            <div className='media-area'>
                                <div className='media-header'>
                                        ...
                                        <Col
                                            ...
                                            <div className='avatar'>
                                                <Media
                                                    ...
                                                    className='shadow'
                                                    object
                                                    src={require('assets/argon-design/img/faces/team-2.jpg')}></Media>
                                            </div>
                                            <div className='text'>
                                                <span className='name'>
                                                    Tom Hanks
                                    ...
                                    <div className='image'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/theme/wade.jpg')}></img>
                                    </div>
                                    <p className='description'>
                                        If you’ve ever wanted to train a machine
                                        learning model and integrate it with
                                        IFTTT, you now can with a new offering
                                        from MateLabs. MateVerse, a platform
                                        where novices can spin out machine...If
                                        you’ve ever wanted to train a machine
                                        learning model and integrate it with
                                        IFTTT, you now can with a new offering
                                        from MateLabs. MateVerse, a platform
                                        where novices can spin out machine...{' '}
                                        <a
                                            href='#pablo'
