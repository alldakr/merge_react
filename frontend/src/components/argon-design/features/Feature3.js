        ...
        <>
            <div
                ...
                style={{
                    backgroundImage:
                        'url(' +
                        require('assets/argon-design/img/ill/p31.svg') +
                        ')',
                }}>
                <Container>
                    <Row className='text-center justify-content-center'>
                        <Col lg='8'>
                            ...
                            <p className='lead text-white'>
                                ...
                                opportunity to play this game of life you need
                        ...
                        <Col lg='6'>
                            <div className='info info-horizontal bg-white'>
                                ...
                                <div className='description pl-4'>
                                    ...
                                    <p>
                                        People are so scared to lose that they
                                        don't even try. Like, one thing people
