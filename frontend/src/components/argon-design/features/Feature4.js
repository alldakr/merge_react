                ...
                <Container>
                    <Row>
                        <Col className='text-center mx-auto' md='8'>
                            ...
                            <p className='lead'>
                                The time is now to be okay to be the greatest
                                you. Would you believe in what you believe in,
                    ...
                    <Row className='align-items-center'>
                        <Col className='mr-auto text-left mt-4' lg='4'>
                            <Card className='bg-default shadow border-0'>
                                <CardImg
                                    alt='...'
                                    src={require('assets/argon-design/img/theme/img-1-1200x1000.jpg')}
                                    top></CardImg>
                                <blockquote className='card-blockquote'>
                                    <svg
                                        ...
                                        <polygon
                                            ...
                                            points='0,52 583,95 0,95'></polygon>
                                        <polygon
                                            className='fill-default'
                                            opacity='.2'
                                            points='0,42 583,95 683,0 0,95'></polygon>
                                    </svg>
                                ...
                                <Col md='6'>
                                    <div className='info info-hover-warning'>
                                        ...
                                        <p className='description opacity-8'>
                                            It becomes harder for us to give
                                            others a hand. We get our heart
                            ...
                            <Row className='mt-lg-4'>
                                <Col md='6'>
                                    <div className='info info-hover-danger'>
                                        ...
                                        <p className='description opacity-8'>
                                            We’re not always in the position
                                            that we want to be at. We’re
                                            constantly growing.
                                        </p>
                                    </div>
                                </Col>
