                    ...
                    <Col className='p-5 ml-auto' md='5'>
                        <div className='p-3'>
                            <img
                                ...
                                src={require('assets/argon-design/img/faces/fezbot.jpg')}></img>
                        </div>
                    </Col>
                </Row>
            </Container>
                    ...
                    <Col className='p-5 ml-auto' md='5'>
                        <div className='p-3'>
                            <img
                                alt='...'
                                className='img-fluid rounded shadow transform-perspective-right'
                                src={require('assets/argon-design/img/faces/brooke-cagle.jpg')}></img>
                        </div>
                    </Col>
                </Row>
            </Container>
        ...
        <>
            <div
                ...
                style={{
                    backgroundImage:
                        'url(' +
                        require('assets/argon-design/img/ill/testimonial_bg.svg') +
                        ')',
                }}>
                <Container>
                    <Row>
