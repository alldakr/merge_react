                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div className='img-container'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/jacket.png')}></img>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div className='img-container'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/boots.png')}></img>
                                    </div>
                                </td>
                                <td className='td-name'>
                                    <a
                            ...
                            <tr>
                                <td>
                                    <div className='img-container'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/sweater.png')}></img>
                                    </div>
                                </td>
                                <td className='td-name'>
                                    <a
                            ...
                            <tr>
                                ...
                                <td className='text-right' colSpan='2'>
                                    ...
                                    <UncontrolledTooltip
                                        delay={0}
                                        target='tooltip663251633'></UncontrolledTooltip>
                                </td>
                            </tr>
                        </tbody>
                    </Table>
