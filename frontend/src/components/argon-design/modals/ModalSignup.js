                            ...
                            <div className='btn-wrapper text-center'>
                                <Button
                                    ...
                                    <span className='btn-inner--icon'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/icons/common/google.svg')}></img>
                                    </span>{' '}
                                ...
                                <Button
                                    ...
                                    <span className='btn-inner--icon'>
                                        <img
                                            alt='...'
                                            src={require('assets/argon-design/img/icons/common/github.svg')}></img>
                                    </span>{' '}
                                    <span className='btn-inner--text'>
                                        Github
                                    </span>
