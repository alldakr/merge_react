...
const items = [
    {
        src: require('assets/argon-design/img/pages/shirt.png'),
        altText: '',
        caption: '',
    },
    {
        src: require('assets/argon-design/img/pages/shorts.png'),
        altText: '',
        caption: '',
    },
    {
        src: require('assets/argon-design/img/pages/tshirt.png'),
        altText: '',
        caption: '',
    },
];
                    ...
                    <Row>
                        ...
                        <Col className='mx-auto' lg='6' md='12'>
                            ...
                            <p className='description'>
                                ...
                                flattering cutouts through the torso and back.
