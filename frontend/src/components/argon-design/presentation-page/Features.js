                        ...
                        <Col className='pt-5' lg='6' md='12'>
                            <div className='info info-horizontal'>
                                ...
                                <div className='description pl-4 pt-2'>
                                    ...
                                    <p>
                                        ...
                                        expensive.Using Argon Design System PRO
                                        you don't have to worry about
                                        customising the basic Bootstrap 4 design
                                        or its components.
                                    </p>
                                </div>
                            </div>
                            <div className='info info-horizontal'>
                                ...
                                <div className='description pl-4 pt-2'>
                                    ...
                                    <p>
                                        It is built over Bootstrap 4, it's fully
                                        responsive and has all the benefits of
                                        the flexbox for the layout, grid system
                                        and components. This is a huge advantage
                                        when you work with columns.
                                    </p>
                                </div>
                            </div>
                            <div className='info info-horizontal'>
                                ...
                                <div className='description pl-4 pt-2'>
                                    ...
                                    <p>
                                        Using Argon Design System PRO you can
                                        create hundreds of components
                                        combinations within seconds and present
                                        them to your client. You just need to
                        ...
                        <Col lg='6' md='12'>
                            <div className='image-container'>
                                <img
                                    alt='...'
                                    className='w-100'
                                    src={require('assets/argon-design/img/presentation-page/ipad.png')}></img>
                            </div>
                        </Col>
                    </Row>
                </Container>
