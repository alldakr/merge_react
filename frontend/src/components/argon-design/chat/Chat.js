                            ...
                            <ListGroupItem
                                ...
                                <Media>
                                    <img
                                        alt='...'
                                        className='avatar'
                                        src={require('assets/argon-design/img/faces/christian.jpg')}></img>
                            ...
                            <Row className='justify-content-end text-right'>
                                <Col className='col-auto'>
                                    <Card className='bg-gradient-primary text-white'>
                                        <CardBody className='p-2'>
                                            <p className='mb-1'>
                                                Can it generate daily design
                                                links that include essays and
                                                data visualizations ?<br></br>
                                            </p>
                                            <div>
                                                <small className='opacity-60'>
                                                    3:30am
                            ...
                            <Row className='justify-content-start'>
                                <Col className='col-auto'>
                                    <Card>
                                        <CardBody className='p-2'>
                                            <p className='mb-1'>
                                                Yeah! Responsive Design is
                                                geared towards those trying to
                                                build web apps
                                            </p>
                                            <div>
                                                <small className='opacity-60'>
                            ...
                            <Row className='justify-content-start'>
                                <Col className='col-auto'>
                                    <Card>
                                        <CardBody className='p-2'>
                                            <p className='mb-1'>
                                                You can easily get it; The
                                                content here is all free
                                            </p>
                                            <div>
                                                <small className='opacity-60'>
                                                    <i className='far fa-clock'></i>
                            ...
                            <Row className='justify-content-end text-right'>
                                <Col className='col-auto'>
                                    <Card className='bg-gradient-primary text-white'>
                                        <CardBody className='p-2'>
                                            <p className='mb-1'>
                                                Awesome, blog is important
                                                source material for anyone who
                                                creates apps? beacuse these
                                                blogs offer a lot of information
                                        ...
                                        <CardBody className='p-2'>
                                            <Col className='p-0' xs='12'>
                                                <img
                                                    ...
                                                    src={require('assets/argon-design/img/theme/img-1-1200x1000.jpg')}></img>
                                            </Col>
                                            <div>
                                                <small className='opacity-60'>
                                                    <i className='far fa-clock'></i>
                                    ...
                                    <Card className='bg-gradient-primary text-white'>
                                        <CardBody className='p-2'>
                                            <p className='mb-0'>
                                                ...
                                                native dev apps is where users
                                                are
                                            </p>
                                            <div>
                                                <small className='opacity-60'>
                                ...
                                <Col className='col-auto'>
                                    <Card>
                                        <CardBody className='p-2'>
                                            ...
                                            <p className='d-inline-block mr-2 mb-1 mt-1'>
                                                Typing...
                                            </p>
                                        </CardBody>
                                    </Card>
