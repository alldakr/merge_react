...
import defaultImage from 'assets/argon-dashboard/img/image_placeholder.jpg';
import defaultAvatar from 'assets/argon-dashboard/img/placeholder.jpg';
    ...
    render() {
        return (
            <div className='fileinput text-center'>
                ...
                <div
                    className={
                        'thumbnail' + (this.props.avatar ? ' img-circle' : '')
                    }>
